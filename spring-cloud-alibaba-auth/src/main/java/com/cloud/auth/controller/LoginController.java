 ...
 */
@RestController
@RequestMapping("login")//AUC-鉴权中心
public class LoginController {
    // 会话登录接口  ---- http://localhost:18087/auth/login/doLogin?name=zhang&pwd=123456
    ...
    // 查询当前登录状态  ---- http://localhost:18087/auth/login/isLogin
    ...
    // 校验当前登录状态  ---- http://localhost:18087/auth/auth/checkLogin
    ...
    // 获取当前登录的账号是谁  ---- http://localhost:18087/auth/login/getLoginId
    ...
    // 查询 Token 信息  ---- http://localhost:18087/auth/login/tokenInfo
    ...
    // 会话注销  ---- http://localhost:18087/auth/login/logout
